...
class SolicitudOperativeStatusServiceTest extends TestCase
{
    ...
    public static function statusCombinations(): array
    {
        return [
            ...
            'waits for every dispensing' => [['dispensada', 'aprobada'], 'aprobada'],
            'all dispensed' => [['dispensada', 'dispensada'], 'dispensada'],
            'waits for every preparation after dispensing' => [['preparada', 'dispensada'], 'dispensada'],
