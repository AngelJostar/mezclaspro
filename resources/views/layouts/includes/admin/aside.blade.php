<aside id="logo-sidebar"
    ...
    x-data="{ openMenu: '{{ request()->routeIs('admin.instituciones.billing.*') ? 'facturacion' : (request()->routeIs('admin.instituciones.reportes') ? 'administracion' : '') }}' || null }" aria-label="Sidebar">
