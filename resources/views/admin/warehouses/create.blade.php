<x-admin-layout>
    <div class="rounded-lg bg-white p-5 shadow-sm md:p-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-medium text-gray-900">Crear nuevo almacen</h1>
                <p class="mt-1 text-sm text-gray-500">Vincula el almacen con el laboratorio que abastece sus inventarios.</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.warehouses.store') }}" class="mt-6 border-t border-gray-200 pt-5">
            @csrf
